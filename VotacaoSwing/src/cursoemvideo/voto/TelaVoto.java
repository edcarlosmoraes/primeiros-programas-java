...
public class TelaVoto extends javax.swing.JFrame {
    ...
    private void btnVotoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVotoActionPerformed
        ...
        int i = 2021 - a;
        if (i < 16){
            lblR.setText("<html>Sua idade é " + i + " portanto <strong>Não Vota!</strong></html>");
        } else if ((i >= 16 && i <18) || (i >= 70)){
                lblR.setText("<html>Sua idade é " + i + " portanto o Voto é <strong>Opcional</strong></html>");
        } else {
               lblR.setText("<html>Sua idade é " + i + " portanto o Voto é <strong>Obrigatório</strong></html>"); 
        }
